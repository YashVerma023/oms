...
| `usersetting` | `usersetting` | `.csv` | — | **7** | replace | `User ID` | **yes** |
...
Also confirmed: a 383-row file with 5 repeated `userId`s loads 378 and reports
5; duplicates across two `usersetting` files resolve to the later file's row;
